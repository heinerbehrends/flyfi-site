    ...
    >
      <Card
        ...
        text={`Wetenschappelijke studies hebben keer op keer bewezen dat veel gebruikers
             afhaken als een website te lang laadt. Een flyfi app laadt tot 15 keer 
             sneller dan een WordPress website. Met de optimale performance van flyfi 
      ...
      <Card
        ...
        text={`Flyfi's progressive web apps zijn een geschikt alternatief voor de 
        ontwikkeling van Android en iOS apps. Ze zijn beter vindbaar, makkelijker te 
        installeren en te updaten, gunstiger in de ontwikkeling en verhogen de conversie.`}
      />
    </Grid>
  )
}
